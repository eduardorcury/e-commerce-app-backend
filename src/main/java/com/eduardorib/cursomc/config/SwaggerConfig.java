package com.eduardorib.cursomc.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.eduardorib.cursomc.resources"))
				.paths(PathSelectors.any()).build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("RESTful API do curso Spring Boot com Ionic",
				"Esta API foi desenvolvida no curso Spring Boot presente na plataforma Udemy", "Versão 1.0",
				"https://www.udemy.com/terms",
				new Contact("Eduardo Ribeiro Cury", "https://github.com/eduardorcury", "eduardoribeirocury@gmail.com"),
